...
# This script is used to clip all of CHELSA CMIP6 historical data to Guam and Tutuila extent 
...
for(i in clim_list){
  ...
  # ALL OUTPUT RASTERS ARE 0.1 VALUE OF ORIGINAL - I AM NOT SURE HOW  - BUT THEY WERE SCALED
  # THEY ARE ALL WGS CS
